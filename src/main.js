...
ScrollTrigger.defaults({ markers: false });
 ...
 // Activamos el plugin de scroll 
        ...
        btnEntrar.addEventListener('click', () => {
            ...
            gsap.to("#cortina-izq", { x: "-100%", duration: 0.5, ease: "power3.inOut" });
            gsap.to("#cortina-der", { x: "100%", duration: 0.5, ease: "power3.inOut", onComplete: () => {
        ...
        gsap.to("#carrusel", {
            ...
            gsap.from(".pelicula", {
                ...
                opacity: 0,
                duration: 0.8,
                stagger: 0.3, // Tiempo de espera entre cada caja (cascada)
